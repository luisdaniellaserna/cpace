...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $sql = "SELECT * FROM aud WHERE aud_id = $id";
    ...
    $stmt = $conn->prepare("UPDATE aud SET 
        question = ?, 
        opt1 = ?, 
        opt2 = ?, 
        opt3 = ?, 
...
<a href="q1.php" class="back-button">&#8592;</a>
<form class="section" method="post" enctype="multipart/form-data">
    ...
    <h3>Topic:</h3>
    <select name="topic">
        <option value="Fundamentals" <?php echo $topic == 'Fundamentals' ? 'selected' : ''; ?>>Fundamentals of auditing and assurance services</option>
        <option value="Risk-based" <?php echo $topic == 'Risk-based' ? 'selected' : ''; ?>>Risk-based Financial Statement Audit</option>
        <option value="Understanding" <?php echo $topic == 'Understanding' ? 'selected' : ''; ?>>Understanding the Entity and Internal Control</option>
        <option value="Audit Evidence" <?php echo $topic == 'Audit Evidence' ? 'selected' : ''; ?>>Audit Evidence and Documentation</option>
        <option value="Audit Completion" <?php echo $topic == 'Audit Completion' ? 'selected' : ''; ?>>Audit Completion and Reporting</option>
        <option value="CIS" <?php echo $topic == 'CIS' ? 'selected' : ''; ?>>Auditing in CIS Environment</option>
        <option value="Attestation" <?php echo $topic == 'Attestation' ? 'selected' : ''; ?>>Attestation Services</option>
        <option value="Governance" <?php echo $topic == 'Governance' ? 'selected' : ''; ?>>Governance, Ethics, and Quality Management</option>
        <option value="Risk Response" <?php echo $topic == 'Risk Response' ? 'selected' : ''; ?>>Risk Response and Reporting</option>
    </select>
