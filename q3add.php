...
<div class="taskbar">
    <div class="logo"></div>
<h1 class="white-text">Management Services </h1>
    <a href="q3.php" class="back-button">&#8592; Back</a>
</div>
<form class="section" action="q3php.php" method="post" enctype="multipart/form-data">
  <h1>Add Questions</h1>
    ...
    <div class="questionSection" id="questionSection1">
      ...
      <div class="topicInput">
        ...
        <select name="topic[]" required>
            <option value="Man Acc">Management Accounting</option>
            <option value="Fin Man">Financial Management</option>
            <option value="Eco">Economic Concept</option>
        </select>
      </div>
    </div>
  </div>
