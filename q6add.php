...
<div class="taskbar">
    <div class="logo"></div>
<h1 class="white-text">Regulatory Framework for Business Transaction</h1>
    <a href="q6.php" class="back-button">&#8592; Back</a>
</div>
<a href="q6.php" class="back-button">&#8592;</a>

<form class="section" action="q6php.php" method="post" enctype="multipart/form-data">
  <h1>Add Questions</h1>
    ...
    <div class="questionSection" id="questionSection1">
      ...
      <div class="topicInput">
        ...
        <select name="topic[]" required>
            <option value="LBT">Law on Business Transactions</option>
            <option value="Bouncing">Bouncing Checks (BP 22) </option>
            <option value="Consumer">Consumer Protection</option>
            <option value="Rehabilitation">Financial Rehabilitation and Insolvency</option>
            <option value="PHCA">Philippine Competition Act</option>
            <option value="Procurement">Government Procurement Law</option>
            <option value="LBO">Law on Business Organizations</option>
            <option value="LOBT">Law on Other Business Transactions</option>
            <option value="Security Law">Labor and Social Security Laws</option>
            <option value="Doing Business">Ease of Doing Business Act</option>
        </select>
      </div>
    </div>
  </div>
