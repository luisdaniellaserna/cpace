...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $sql = "SELECT * FROM financial WHERE fin_id = $id";
    ...
    $stmt = $conn->prepare("UPDATE financial SET 
        question = ?, 
        opt1 = ?, 
        opt2 = ?, 
        opt3 = ?, 
...
<form class="section" method="post" enctype="multipart/form-data">
    ...
    <h3>Topic:</h3>
    <select name="topic">
        <option value="Fin Rep" <?php echo $topic == 'Fin Rep' ? 'selected' : ''; ?>>Development of Financial Reporting Framework</option>
        <option value="Fin State" <?php echo $topic == 'Fin State' ? 'selected' : ''; ?>>Conceptual Framework and Presentation of Financial Statements</option>
        <option value="Key Accounting" <?php echo $topic == 'Key Accounting' ? 'selected' : ''; ?>>Key Accounting Areas</option>
        <option value="Other" <?php echo $topic == 'Other' ? 'selected' : ''; ?>>Other Accounting Topics</option>
        <option value="Specialized" <?php echo $topic == 'Specialized' ? 'selected' : ''; ?>>Specialized Reporting</option>
    </select>
