...
<head>
  <meta charset="utf-8">
  <title>Advance Financial Question Config</title>
...
<!-- Add Questions Form -->
<div class="section">
  <h1>Advanced Financial Accounting and Reporting</h1>
  ...
  <table id="table1" class="table">
    ...
    <tbody>
      ...
      if (!empty($searchQuery)) {
          $sql = "SELECT * FROM adv WHERE question LIKE '%$searchQuery%'";
      } else {
          $sql = "SELECT * FROM adv";
      }
      ...
      while ($row = $result->fetch_assoc()) {
          ...
          echo "<td>
                <a href='/CPA/q2Edit.php?id={$row['adv_id']}'>
                  <button class='edit-button'>Edit</button>
                </a>
                <a href='/CPA/q2Delete.php?id={$row['adv_id']}'>
