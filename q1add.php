...
<div class="taskbar">
    <div class="logo"></div>
<h1 class="white-text">Financial Accounting and Reporting</h1>
    <a href="q1.php" class="back-button">&#8592; Back</a>
</div>
<form class="section" action="q1php.php" method="post" enctype="multipart/form-data">
  ...
  <div id="questionsContainer">
    ...
    <div class="questionSection" id="questionSection1">
      ...
      <div class="textQuestionInput">
        ...
        <textarea id="questionText1" name="questionText[]" placeholder="Input your question here." required maxlength="1000" oninput="updateCharacterCount('questionText1', 1000)"></textarea>
        <span id="questionText1Count">0/1000</span>
      </div>
      ...
      <div class="topicInput">
        ...
        <select name="topic[]" required>
            <option value="Fin Rep">Development of Financial Reporting Framework</option>
            <option value="Fin State">Conceptual Framework and Presentation of Financial Statements</option>
            <option value="Key Accounting">Key Accounting Areas</option>
            <option value="Other">Other Accounting Topics</option>
            <option value="Specialized">Specialized Reporting</option>
        </select>
      </div>
    </div>
  </div>
