...
<head>
  <meta charset="utf-8">
  <title>Financial Question Config</title>
...
<!-- Add Questions Form -->
<div class="section">
  <h1>Financial Accounting and Reporting</h1>
  ...
  <table id="table1" class="table">
    ...
    <tbody>
      ...
      if (!empty($searchQuery)) {
          $sql = "SELECT * FROM financial WHERE question LIKE '%$searchQuery%'";
      } else {
      ...
      while ($row = $result->fetch_assoc()) {
          ...
          echo "<td>
                <a href='/CPA/q1Edit.php?id={$row['fin_id']}'>
                  <button class='edit-button'>Edit</button>
                </a>
                <a href='/CPA/q1Delete.php?id={$row['fin_id']}'>
