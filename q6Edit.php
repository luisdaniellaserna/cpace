...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $stmt = $conn->prepare("UPDATE reg SET 
        question = ?, 
        opt1 = ?, 
        opt2 = ?, 
        opt3 = ?, 
...
<a href="q6.php" class="back-button">&#8592;</a>
<form class="section" method="post" enctype="multipart/form-data">
    ...
    <h3>Topic:</h3>
    <select name="topic">
        <option value="LBT" <?php echo $topic == 'LBT' ? 'selected' : ''; ?>>Law on Business Transactions</option>
        <option value="Bouncing" <?php echo $topic == 'Bouncing' ? 'selected' : ''; ?>>Bouncing Checks (BP 22) </option>
        <option value="Consumer" <?php echo $topic == 'Consumer' ? 'selected' : ''; ?>>Consumer Protection</option>
        <option value="Rehabilitation" <?php echo $topic == 'Rehabilitation' ? 'selected' : ''; ?>>Financial Rehabilitation and Insolvency</option>
        <option value="PHCA" <?php echo $topic == 'PHCA' ? 'selected' : ''; ?>>Philippine Competition Act</option>
        <option value="Procurement" <?php echo $topic == 'Procurement' ? 'selected' : ''; ?>>Government Procurement Law</option>
        <option value="LBO" <?php echo $topic == 'LBO' ? 'selected' : ''; ?>>Law on Business Organizations</option>
        <option value="LOBT" <?php echo $topic == 'LOBT' ? 'selected' : ''; ?>>Law on Other Business Transactions</option>
        <option value="Security Law" <?php echo $topic == 'Security Law' ? 'selected' : ''; ?>>Labor and Social Security Laws</option>
        <option value="Doing Business" <?php echo $topic == 'Doing Business' ? 'selected' : ''; ?>>Ease of Doing Business Act</option>
    </select>
