...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $stmt = $conn->prepare("UPDATE tax SET 
        question = ?, 
        opt1 = ?, 
        opt2 = ?, 
        opt3 = ?, 
...
<a href="q5.php" class="back-button">&#8592;</a>
<form class="section" method="post" enctype="multipart/form-data">
    ...
    <h3>Topic:</h3>
    <select name="topic">
        <option value="Principles" <?php echo $topic == 'Principles' ? 'selected' : ''; ?>>Principles of Taxation</option>
        <option value="Remedies" <?php echo $topic == 'Remedies' ? 'selected' : ''; ?>>Tax Remedies</option>
        <option value="Income Tax" <?php echo $topic == 'Income Tax' ? 'selected' : ''; ?>>Income Taxation</option>
        <option value="Transfer Tax" <?php echo $topic == 'Transfer Tax' ? 'selected' : ''; ?>>Transfer Taxes</option>
        <option value="Business Tax" <?php echo $topic == 'Business Tax' ? 'selected' : ''; ?>>Business Taxes</option>
        <option value="Doc Stamp" <?php echo $topic == 'Doc Stamp' ? 'selected' : ''; ?>>Documentary Stamp Tax</option>
        <option value="Excise Tax" <?php echo $topic == 'Excise Tax' ? 'selected' : ''; ?>>Excise Tax</option>
        <option value="Gov Tax" <?php echo $topic == 'Gov Tax' ? 'selected' : ''; ?>>Local Government Taxation</option>
        <option value="Prefer Tax" <?php echo $topic == 'Prefer Tax' ? 'selected' : ''; ?>>Preferential Taxation</option>
    </select>
