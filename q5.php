...
<head>
  <meta charset="utf-8">
  <title>Taxation Question Config</title>
  ...
  <table id="table1" class="table">
    ...
    <tbody>
      ...
      if (!empty($searchQuery)) {
          $sql = "SELECT * FROM tax WHERE question LIKE '%$searchQuery%'";
      } else {
          $sql = "SELECT * FROM tax";
      }
      ...
      while ($row = $result->fetch_assoc()) {
          ...
          echo "<td>
                <a href='/CPA/q5Edit.php?id={$row['tax_id']}'>
                  <button class='edit-button'>Edit</button>
                </a>
                <a href='/CPA/q5Delete.php?id={$row['tax_id']}'>
